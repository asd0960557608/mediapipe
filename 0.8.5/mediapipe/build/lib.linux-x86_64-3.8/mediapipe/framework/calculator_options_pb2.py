...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CALCULATOROPTIONS'].fields_by_name['merge_fields']._options = None
  _globals['_CALCULATOROPTIONS'].fields_by_name['merge_fields']._serialized_options = b'\030\001'
