...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PACKETGENERATOROPTIONS']._serialized_end=93
  _globals['_PACKETGENERATORCONFIG']._serialized_start=96
  _globals['_PACKETGENERATORCONFIG']._serialized_end=303
